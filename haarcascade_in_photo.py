...
path = '/home/v/Dropbox/novo/imagens/'
os.chdir(path)
...
for file in file_list:
    ...
    face_cascade = cv2.CascadeClassifier('/home/v/Dropbox/novo/haarcascade_frontalface_default.xml')
    face_alt_cascade = cv2.CascadeClassifier('/home/v/Dropbox/novo/haarcascade_frontalface_default.xml')
    face_alt2_cascade = cv2.CascadeClassifier('/home/v/Dropbox/novo/haarcascade_frontalface_default.xml')
    face_alt_tree_cascade = cv2.CascadeClassifier('/home/v/Dropbox/novo/haarcascade_frontalface_default.xml')
    ...
    faces = face_cascade.detectMultiScale(gray, scaleFactor=1.035, minNeighbors=3, minSize=(30,30))
    faces2 = face_alt_cascade.detectMultiScale(gray, 1.035, 3, minSize=(30,30))
    faces3 = face_alt2_cascade.detectMultiScale(gray, 1.035, 3, minSize=(30,30))
    faces4 = face_alt_tree_cascade.detectMultiScale(gray, 1.035, 3, minSize=(30,30))
